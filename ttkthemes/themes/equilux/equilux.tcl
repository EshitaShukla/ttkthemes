    ...
    ttk::style theme create equilux -parent default -settings {
        ...
        ttk::style element create Entry.field \
            image [list $images(entry-border-bg-solid) \
                        focus $images(entry-border-active-bg-solid) \
                        disabled $images(entry-border-disabled-bg)] \
        ...
        ttk::style element create Combobox.field \
            image [list $images(combo-entry) \
                ...
                {focus}    $images(combo-entry-focus) \
        ...
        ttk::style element create Spinbox.field \
            image [list $images(combo-entry) focus $images(combo-entry-focus)] \
        ...
        #ttk::style element create Separator.separator image $images()
